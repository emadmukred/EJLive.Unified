...
## CODEX COMMAND — [Track 030] Screenshot Capture Delivery

**Suggested branch:** `track-030-screenshot-capture-delivery`  
...
7. Use one isolated branch only. Suggested branch name: track-030-screenshot-capture-delivery
