...
## CODEX COMMAND — [Track 019] XFS Normalization Contracts

**Suggested branch:** `track-019-xfs-normalization-contracts`  
...
7. Use one isolated branch only. Suggested branch name: track-019-xfs-normalization-contracts
