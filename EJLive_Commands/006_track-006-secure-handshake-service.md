...
## CODEX COMMAND — [Track 006] Secure Handshake Service

**Suggested branch:** `track-006-secure-handshake-service`  
...
7. Use one isolated branch only. Suggested branch name: track-006-secure-handshake-service
