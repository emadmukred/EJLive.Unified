...
## CODEX COMMAND — [Track 016] Diebold/Agilis EJ Parser Skeleton

**Suggested branch:** `track-016-diebold-agilis-ej-parser-skeleton`  
...
[Track 016] Diebold/Agilis EJ Parser Skeleton
GitHub Issue: (create/use matching GitHub Issue)
...
7. Use one isolated branch only. Suggested branch name: track-016-diebold-agilis-ej-parser-skeleton
...
## Target Files / Layers
**Target layer:** Core/Parsing/Diebold
