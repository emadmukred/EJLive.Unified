...
## CODEX COMMAND — [Track 034] Structured Logging and Correlation IDs

**Suggested branch:** `track-034-structured-logging-and-correlation-ids`  
...
7. Use one isolated branch only. Suggested branch name: track-034-structured-logging-and-correlation-ids
