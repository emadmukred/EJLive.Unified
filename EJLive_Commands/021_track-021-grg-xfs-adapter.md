...
## CODEX COMMAND — [Track 021] GRG XFS Adapter

**Suggested branch:** `track-021-grg-xfs-adapter`  
...
7. Use one isolated branch only. Suggested branch name: track-021-grg-xfs-adapter
...
## Objective
تطبيع أحداث XFS/Trace الخاصة بـ GRG.
...
```text
Task: Implement GRG XFS adapter.

Required work:
1. Create `GRGXfsAdapter` implementing IXfsVendorAdapter.
