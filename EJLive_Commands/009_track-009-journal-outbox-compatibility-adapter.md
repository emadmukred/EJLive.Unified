...
## CODEX COMMAND — [Track 009] Journal Outbox Compatibility Adapter

**Suggested branch:** `track-009-journal-outbox-compatibility-adapter`  
...
7. Use one isolated branch only. Suggested branch name: track-009-journal-outbox-compatibility-adapter
