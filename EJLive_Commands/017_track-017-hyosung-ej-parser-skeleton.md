...
## CODEX COMMAND — [Track 017] Hyosung EJ Parser Skeleton

**Suggested branch:** `track-017-hyosung-ej-parser-skeleton`  
...
[Track 017] Hyosung EJ Parser Skeleton
GitHub Issue: (create/use matching GitHub Issue)
...
7. Use one isolated branch only. Suggested branch name: track-017-hyosung-ej-parser-skeleton
...
## Target Files / Layers
**Target layer:** Core/Parsing/Hyosung
