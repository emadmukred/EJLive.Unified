...
## CODEX COMMAND — [Track 020] NCR XFS Adapter

**Suggested branch:** `track-020-ncr-xfs-adapter`  
...
7. Use one isolated branch only. Suggested branch name: track-020-ncr-xfs-adapter
...
## Objective
تطبيع أحداث XFS/Trace الخاصة بـ NCR.
...
```text
Task: Implement NCR XFS adapter.

Required work:
1. Create `NCRXfsAdapter` implementing IXfsVendorAdapter.
