...
## CODEX COMMAND — [Track 031] Server Dashboard Snapshot Model

**Suggested branch:** `track-031-server-dashboard-snapshot-model`  
...
7. Use one isolated branch only. Suggested branch name: track-031-server-dashboard-snapshot-model
