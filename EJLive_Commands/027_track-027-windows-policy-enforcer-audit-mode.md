...
## CODEX COMMAND — [Track 027] Windows Policy Enforcer Audit Mode

**Suggested branch:** `track-027-windows-policy-enforcer-audit-mode`  
...
7. Use one isolated branch only. Suggested branch name: track-027-windows-policy-enforcer-audit-mode
