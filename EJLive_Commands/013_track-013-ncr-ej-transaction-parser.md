...
## CODEX COMMAND — [Track 013] NCR EJ Transaction Parser

**Suggested branch:** `track-013-ncr-ej-transaction-parser`  
...
7. Use one isolated branch only. Suggested branch name: track-013-ncr-ej-transaction-parser
