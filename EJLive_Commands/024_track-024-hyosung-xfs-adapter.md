...
## CODEX COMMAND — [Track 024] Hyosung XFS Adapter

**Suggested branch:** `track-024-hyosung-xfs-adapter`  
...
7. Use one isolated branch only. Suggested branch name: track-024-hyosung-xfs-adapter
