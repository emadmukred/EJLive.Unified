...
## CODEX COMMAND — [Track 008] Advanced File Watcher and Safe Live File Reader

**Suggested branch:** `track-008-advanced-file-watcher-and-safe-live-file-reader`  
...
7. Use one isolated branch only. Suggested branch name: track-008-advanced-file-watcher-and-safe-live-file-reader
