...
## CODEX COMMAND — [Track 029] File Image Distribution Service

**Suggested branch:** `track-029-file-image-distribution-service`  
...
7. Use one isolated branch only. Suggested branch name: track-029-file-image-distribution-service
