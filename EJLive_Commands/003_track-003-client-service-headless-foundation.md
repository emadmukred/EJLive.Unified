...
## CODEX COMMAND — [Track 003] Client Service Headless Foundation

**Suggested branch:** `track-003-client-service-headless-foundation`  
**GitHub Issue:** `#5`
...
7. Use one isolated branch only. Suggested branch name: track-003-client-service-headless-foundation
