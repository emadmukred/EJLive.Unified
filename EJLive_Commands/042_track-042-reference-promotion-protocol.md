...
## CODEX COMMAND — [Track 042] Reference Promotion Protocol

**Suggested branch:** `track-042-reference-promotion-protocol`  
...
7. Use one isolated branch only. Suggested branch name: track-042-reference-promotion-protocol
