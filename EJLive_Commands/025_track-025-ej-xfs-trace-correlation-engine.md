...
## CODEX COMMAND — [Track 025] EJ XFS TRACE Correlation Engine

**Suggested branch:** `track-025-ej-xfs-trace-correlation-engine`  
...
[Track 025] EJ XFS TRACE Correlation Engine
GitHub Issue: (create/use matching GitHub Issue)
...
7. Use one isolated branch only. Suggested branch name: track-025-ej-xfs-trace-correlation-engine
