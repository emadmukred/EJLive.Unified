...
## CODEX COMMAND — [Track 023] Diebold XFS Adapter

**Suggested branch:** `track-023-diebold-xfs-adapter`  
...
7. Use one isolated branch only. Suggested branch name: track-023-diebold-xfs-adapter
