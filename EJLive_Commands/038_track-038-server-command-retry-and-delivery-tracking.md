...
## CODEX COMMAND — [Track 038] Server Command Retry and Delivery Tracking

**Suggested branch:** `track-038-server-command-retry-and-delivery-tracking`  
...
7. Use one isolated branch only. Suggested branch name: track-038-server-command-retry-and-delivery-tracking
