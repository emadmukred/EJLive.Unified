...
## CODEX COMMAND — [Track 015] Wincor/ProView EJ Parser Skeleton

**Suggested branch:** `track-015-wincor-proview-ej-parser-skeleton`  
...
7. Use one isolated branch only. Suggested branch name: track-015-wincor-proview-ej-parser-skeleton
