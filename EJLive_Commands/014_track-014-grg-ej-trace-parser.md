...
## CODEX COMMAND — [Track 014] GRG EJ/TRACE Parser

**Suggested branch:** `track-014-grg-ej-trace-parser`  
...
7. Use one isolated branch only. Suggested branch name: track-014-grg-ej-trace-parser
