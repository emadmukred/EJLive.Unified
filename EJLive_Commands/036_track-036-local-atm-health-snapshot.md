...
## CODEX COMMAND — [Track 036] Local ATM Health Snapshot

**Suggested branch:** `track-036-local-atm-health-snapshot`  
...
[Track 036] Local ATM Health Snapshot
GitHub Issue: (create/use matching GitHub Issue)
...
7. Use one isolated branch only. Suggested branch name: track-036-local-atm-health-snapshot
