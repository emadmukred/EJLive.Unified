...
## CODEX COMMAND — [Track 032] ATM Vendor Strategy Registry

**Suggested branch:** `track-032-atm-vendor-strategy-registry`  
...
7. Use one isolated branch only. Suggested branch name: track-032-atm-vendor-strategy-registry
