...
## CODEX COMMAND — [Track 012] EJ Parser Registry and Contracts

**Suggested branch:** `track-012-ej-parser-registry-and-contracts`  
...
7. Use one isolated branch only. Suggested branch name: track-012-ej-parser-registry-and-contracts
