...
## CODEX COMMAND — [Track 004] UI Backend Separation Gate

**Suggested branch:** `track-004-ui-backend-separation-gate`  
**GitHub Issue:** `#6`
...
7. Use one isolated branch only. Suggested branch name: track-004-ui-backend-separation-gate
