...
## CODEX COMMAND — [Track 039] ATM Journal Request Service

**Suggested branch:** `track-039-atm-journal-request-service`  
...
7. Use one isolated branch only. Suggested branch name: track-039-atm-journal-request-service
