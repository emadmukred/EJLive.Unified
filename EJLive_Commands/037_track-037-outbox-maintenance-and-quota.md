...
## CODEX COMMAND — [Track 037] Outbox Maintenance and Quota

**Suggested branch:** `track-037-outbox-maintenance-and-quota`  
...
7. Use one isolated branch only. Suggested branch name: track-037-outbox-maintenance-and-quota
