...
## CODEX COMMAND — [Track 022] Wincor XFS Adapter

**Suggested branch:** `track-022-wincor-xfs-adapter`  
...
7. Use one isolated branch only. Suggested branch name: track-022-wincor-xfs-adapter
...
## Objective
تطبيع أحداث XFS/Trace الخاصة بـ Wincor.
...
```text
Task: Implement Wincor XFS adapter.

Required work:
1. Create `WincorXfsAdapter` implementing IXfsVendorAdapter.
