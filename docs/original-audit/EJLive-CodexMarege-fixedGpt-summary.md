# EJLive-CodexMarege-fixedGpt Deep Audit

Generated from `legacy/original/EJLive-CodexMarege-fixedGpt`. Build output folders are excluded.
...
| Files missing from active by name | 16 |
| C# files different from active compiled source | 51 |
| Files containing Arabic text | 38 |
| Declared type count | 271 |
| Method-like member count | 849 |
...
| Category | Files |
| --- | ---: |
| Build/Tool Script | 12 |
| Configuration/Data | 27 |
| CSharp Project | 7 |
| CSharp Source | 28 |
| Data/Core Source | 19 |
| Documentation/Requirements | 2 |
| Reference Artifact | 20 |
...
Dependency rows written: 81. See `docs/original-audit/EJLive-CodexMarege-fixedGpt-project-dependencies.csv`.

## File Manifest

Full file-level role map written to `docs/original-audit/EJLive-CodexMarege-fixedGpt-file-manifest.csv`.
