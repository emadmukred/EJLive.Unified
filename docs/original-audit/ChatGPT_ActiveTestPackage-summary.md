# ChatGPT_ActiveTestPackage Deep Audit

Generated from `legacy/original/ChatGPT_ActiveTestPackage`. Build output folders are excluded.
...
Dependency rows written: 63. See `docs/original-audit/ChatGPT_ActiveTestPackage-project-dependencies.csv`.

## File Manifest

Full file-level role map written to `docs/original-audit/ChatGPT_ActiveTestPackage-file-manifest.csv`.
