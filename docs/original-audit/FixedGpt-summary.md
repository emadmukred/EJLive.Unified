...
Generated from `legacy/original/FixedGpt`. Build output folders are excluded.
...
Dependency rows written: 81. See `docs/original-audit/FixedGpt-project-dependencies.csv`.

## File Manifest

Full file-level role map written to `docs/original-audit/FixedGpt-file-manifest.csv`.
