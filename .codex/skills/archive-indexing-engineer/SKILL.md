---
name: archive-indexing-engineer
description: Design server archive storage, journal indexing, checksum metadata, search, and retrieval workflows.
---

# archive-indexing-engineer
