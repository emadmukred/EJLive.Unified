---
name: sqlite-wal-data-engineer
description: Design SQLite WAL schemas, migrations, indexes, durable state stores, and safe local persistence.
---

# sqlite-wal-data-engineer
