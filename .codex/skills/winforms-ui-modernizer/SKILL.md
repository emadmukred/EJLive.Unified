---
name: winforms-ui-modernizer
description: Modernize WinForms UI layouts, controls, tabs, forms, spacing, double-buffering, themes, and NOC ergonomics.
---

# winforms-ui-modernizer
