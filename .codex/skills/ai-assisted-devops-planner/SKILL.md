---
name: ai-assisted-devops-planner
description: Plan local development, environment checks, build scripts, packaging workflow, CI expectations, and release validation.
---

# ai-assisted-devops-planner
