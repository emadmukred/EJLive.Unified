---
name: ejlive-gap-mapper
description: Analyze confirmed gaps between EJLive reference documents, active source, legacy/original code, and the next safe implementation slice.
---
