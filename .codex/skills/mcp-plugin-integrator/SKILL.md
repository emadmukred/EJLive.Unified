---
name: mcp-plugin-integrator
description: Plan safe project use of MCP/connectors such as GitHub, Figma, Hugging Face, Netlify, and design/source tools.
---

# mcp-plugin-integrator
