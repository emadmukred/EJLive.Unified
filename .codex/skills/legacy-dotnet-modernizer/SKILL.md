---
name: legacy-dotnet-modernizer
description: Modernize legacy .NET/WinForms code gradually without breaking current runtime or project structure.
---

# legacy-dotnet-modernizer
