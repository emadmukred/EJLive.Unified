---
name: multi-pdf-project-extractor
description: Extract, compare, and reconcile requirements from multiple DOCX/PDF/MD project references.
---

# multi-pdf-project-extractor
