---
name: requirements-to-backlog-planner
description: Convert reference documents and stakeholder requests into prioritized implementation waves, epics, and safe tasks.
---

# requirements-to-backlog-planner
