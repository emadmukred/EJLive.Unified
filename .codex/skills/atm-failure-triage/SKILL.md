---
name: atm-failure-triage
description: Triage ATM operational failures across journal ingest, dispense behavior, network, host, XFS, Windows, and client/server layers.
---
