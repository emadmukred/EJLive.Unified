---
name: compatibility-testing-codecraft
description: Generate production-grade compatible C# code, tests, build checks, and regression-risk validation.
---

# compatibility-testing-codecraft
