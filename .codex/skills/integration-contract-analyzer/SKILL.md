---
name: integration-contract-analyzer
description: Analyze contracts, DTOs, sync models, commands, acknowledgement flows, and client/server message protocols.
---

# integration-contract-analyzer
