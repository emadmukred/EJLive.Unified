---
name: realtime-sync-device-state
description: Design and verify realtime sync, outbox, queues, ACKs, deduplication, retry, offset tracking, conflict handling, and outage recovery.
---

# realtime-sync-device-state
