---
name: safe-command-queue-engineer
description: Design allowlisted command queues, approvals, execution status, retries, and command audit results.
---

# safe-command-queue-engineer
