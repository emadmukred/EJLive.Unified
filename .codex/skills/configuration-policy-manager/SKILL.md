---
name: configuration-policy-manager
description: Design agent/server configuration models, remote config, policy flags, DPAPI-protected secrets, and validation.
---
