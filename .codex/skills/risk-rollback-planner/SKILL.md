---
name: risk-rollback-planner
description: Identify change risks, operational blast radius, rollback steps, feature flags, and staged deployment plans.
---

# risk-rollback-planner
