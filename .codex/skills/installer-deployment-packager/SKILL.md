---
name: installer-deployment-packager
description: Design installer flows, prerequisites, config selection, service wiring, validation checks, and rollback.
---

# installer-deployment-packager
