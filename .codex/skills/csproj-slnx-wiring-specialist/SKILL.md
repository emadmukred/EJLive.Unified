---
name: csproj-slnx-wiring-specialist
description: Correct project references, compile includes, GUID drift, package references, and solution graph wiring.
---

# csproj-slnx-wiring-specialist
