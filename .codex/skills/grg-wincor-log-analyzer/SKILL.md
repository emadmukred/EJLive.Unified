---
name: grg-wincor-log-analyzer
description: Analyze GRG and Wincor/Nixdorf daily journal and trace files, event sequences, and vendor-specific log patterns.
---

# grg-wincor-log-analyzer
