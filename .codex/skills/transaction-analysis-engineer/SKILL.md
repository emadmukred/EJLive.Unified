---
name: transaction-analysis-engineer
description: Design transaction parsing, STAN/RRN/account/amount extraction, success/failure classification, and anomaly detection.
---

# transaction-analysis-engineer
