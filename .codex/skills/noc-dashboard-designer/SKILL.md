---
name: noc-dashboard-designer
description: Design ATM NOC dashboards, status colors, cards, fleet map/topology, filters, alert bars, and drill-down forms.
---

# noc-dashboard-designer
