---
name: supabase-telemetry-integrator
description: Design optional Supabase telemetry schemas and integration boundaries for monitoring, events, and metrics.
---

# supabase-telemetry-integrator
